...
- 正式 AGENTS 替换与 Canonical 收口完成后，使用不携带历史聊天的独立 AI 做 cold-start；如工具支持独立子代理，可为此明确任务创建无历史上下文的审查代理。保存原始输入/回答及版本；作者自答不算独立验收。负责人对最终交付确认前，Overall 保持 NOT YET VALIDATED。
