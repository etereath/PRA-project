...
| 开发范围、注意力、验证投入与停止条件 | [开发范围与效率治理](docs/pra_development_scope_and_efficiency_governance.md)，按需读取相关节 |
| 测试组织、接口适配、交付细则 | [开发执行参考](docs/development_workflow.md)，按需读取相关节 |
