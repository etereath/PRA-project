...
$env:PRA_COOKIE_SECURE = "false"
$env:PRA_WEB_PUBLIC_SCHEME = "http"
$env:PRA_RUNTIME_DB = "D:\PRA_Runtime\data\pra_runtime.sqlite3"
$env:PRA_PRODUCTS_WORKBOOK = "data\samples\products.xlsx"
$env:PRA_PRICE_RULES_WORKBOOK = "data\samples\price_rules.xlsx"
$env:PRA_LISTING_RULES_WORKBOOK = "data\samples\listing_rules.xlsx"
