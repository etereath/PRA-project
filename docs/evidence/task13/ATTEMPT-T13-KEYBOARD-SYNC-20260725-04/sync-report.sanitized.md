...
- 结果：成功
- 批次 ID：`BATCH-T13-KEYBOARD-SYNC-20260725-04`
- 运行 ID：`ATTEMPT-T13-KEYBOARD-SYNC-20260725-04`
- 快照 ID：`SNAPSHOT-dc0c443e6cab3fb8210bd39d`
- 平台：蚂蚁花团供应商
- 扫描范围：上架中、待上架
- 完整性：两页扫描及结束标记均已确认
...
| AISHA-B-60-Z | 艾莎 | B级 | waiting_only | 0/1 | offline | 正常 |
| AISHA-C-55-Z | 艾莎 | C级 | waiting_only | 0/1 | offline | 正常 |
| AISHA-D-50-Z | 艾莎 | D级 | online_only | 1/0 | online | 正常 |
| 未映射 | 艾莎 | E级 | ambiguous | 0/1 | 保留原值/未投影 | 已创建或更新人工复核 |
