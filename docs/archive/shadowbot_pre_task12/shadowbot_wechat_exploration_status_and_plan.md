...
> 归档说明（2026-07-23）：本文记录任务12之前的探索状态，保留用于追溯元素策略和早期决策，不再作为当前实施计划。当前实现与交接以 [任务12最终交接报告](../../reports/task12_final_handoff_20260723.md)、[当前项目状态](../../project_current_status.md) 和 [平台价格快照与 ShadowBot 改价对接说明](../../shadowbot_listing_status_integration.md) 为准。
...
详见 [shadowbot_fault_injection_20260625.md](../../reports/shadowbot_fault_injection_20260625.md)。
